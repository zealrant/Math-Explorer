...
-(void)viewDidLoad {
	...
	char emptstr[1]={0};
	[probView setText:[NSString stringWithFormat:[NSString stringWithUTF8String:(const char *)sqlite3_column_text(localizer, 0)], sv1==NULL?emptstr:sv1, sv2==NULL?emptstr:sv2, ov1==NULL?emptstr:ov1, ov2==NULL?emptstr:ov2, sqlite3_column_int(localizer, 5), sqlite3_column_int(localizer, 6)]];
	sqlite3_finalize(localizer);
...
-(IBAction)nextClicked:(id)sender {
	...
	[[self navigationController] setViewControllers:[NSArray arrayWithObject:[[MEFindingIntroViewController alloc] initWithNibName:@"MEFindingIntroViewController" bundle:nil]] animated:YES];
}
